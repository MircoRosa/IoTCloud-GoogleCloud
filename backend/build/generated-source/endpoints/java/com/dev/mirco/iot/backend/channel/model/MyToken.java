...
package com.dev.mirco.iot.backend.channel.model;

/**
 * Model definition for MyToken.
 *
 * <p> This is the Java data model class that specifies how to parse/serialize into the JSON that is
 * transmitted over HTTP when working with the channel. For a detailed explanation see:
...
public final class MyToken extends com.google.api.client.json.GenericJson {
   ...
   */
  public java.lang.String getMyToken() {
    return myToken;
  }

  /**
   * @param myToken myToken or {@code null} for none
   */
  public MyToken setMyToken(java.lang.String myToken) {
   ...
   */
  public MyToken setToken(java.lang.String token) {
    this.token = token;
    return this;
  }
